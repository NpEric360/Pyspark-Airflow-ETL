...
key_id = 'AKIA52FTNNG6FCALVD3S'
secret_key = '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'
...
def write_to_s3():
    ...
    local_dir = os.getcwd() + '\data\parquets'
    local_filepath = ''
    s3_path = ''
    ...
    for dirpath,directories,files in os.walk(local_dir):
        ...
        for file in files:
            if file.endswith('parquet'):
                ...
                shutil.move(dirpath, local_dir + '\processed')
